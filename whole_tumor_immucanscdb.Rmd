...
t0 <- SplitObject(seu$Galen_2019_30827681, split.by = "group")
...
test.by <- Run.HiTME(t0[9:10],
                  scGate.model.branch = "dev",
                  return.Seurat = F,
                  ref.maps = ref.maps,
                  ncores = 9)

sp <- scCustomize::Merge_Seurat_List(t0[1:2])
